              ...
              {filtered.map((item, i) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-navy-dark/0 group-hover:bg-navy-dark/50 transition-colors flex items-end p-4">
                    <span className="text-primary-foreground font-medium text-sm opacity-0 group-hover:opacity-100 transition-opacity">
                      {item.title}
                    </span>
                  </div>
                </motion.button>
      ...
      <AnimatePresence>
        {lightboxIndex !== null && (
          ...
          >
            ...
            />
            <p className="absolute bottom-8 text-primary-foreground font-display text-lg">
